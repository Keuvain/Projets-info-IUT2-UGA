...
public class JavaFXGUI extends IHM {
    ...
    @FXML private TextField newUserNumTelTextField;
    ...
    private void start(Stage primaryStage) throws IOException {
        ...
        AccueilCtrl test = mainViewLoader.getController();
        test.initVue(controleur.getGenevent(),new Tournoi());
...
//                this.newUserNumTelTextField.getText().strip()
//        );
